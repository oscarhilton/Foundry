...
export const site = {
  ...
  starterKit: {
    ...
    cubes: [
      ...
      {
        name: "Weather",
        role: "Turns local weather into something your outputs can express.",
      },
      {
        name: "Light",
        role: "Ambient output — visible from across the room.",
      },
    ],
  },
  examples: {
  ...
  examplePresets: [
    {
      ...
      description: "Turns local weather into ambient colour.",
    },
    {
      id: "weather-dial-lcd" as ExamplePresetId,
      title: "Weather Dial LCD",
      chain: "London → Weather → Dial → Display",
      description: "Dial picks which weather line hits the display.",
    },
    {
      id: "split-weather-dual-lcd" as ExamplePresetId,
      title: "Split Weather LCD",
      chain: "London → Weather → Split → Display → Display",
      description: "Place and temperature on one display, rain on the other.",
    },
    {
      id: "presence-weather-lcd" as ExamplePresetId,
      title: "Presence Weather",
      chain: "Motion → London → Weather → Display",
      description: "Weather appears only when motion is detected.",
    },
    {
      id: "world-desk" as ExamplePresetId,
      title: "World Desk",
      chain: "Tokyo → Time → Display · London → Weather → Light · Foundry → GitHub → Light",
      description: "Tokyo clock, London weather, GitHub light — at once.",
    },
  ],
  language: {
